    ...
    <div class="w-1/3"></div>
      <div className="w-2/3 relative">
        ...
        <div className="absolute -left-96 top-1/3">
          ...
          <button class="mt-10 bg-transparent hover:bg-black text-black font-semibold hover:text-white py-2 px-4 border border-black hover:border-transparent rounded">
            Contacteer mij!
          </button>
        </div>
      </div>
