        ...
        <Link href={`/projects/${project.id}`} passHref>
          <a className="group text-white">
              <div className="w-full aspect-w-1 aspect-h-1 overflow-hidden xl:aspect-w-7 xl:aspect-h-8 ">
                <Image loader={myLoader} src={project.attributes.featuredImage.data.attributes.url} width={700} height={450} className="w-full h-full rounded-sm object-center object-cover group-hover:opacity-75"/>
              </div>
